...
When authoring a skill, MUST use the following order:
...
- MUST use `MUST` to denote required behavior and `NEVER` to denote prohibited or anti-pattern behavior in `Core Principles`
